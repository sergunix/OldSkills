...
del /Q v:\Mrs\M2O00101$ORA%LPU%*.*YES
del /Q v:\Mrs\MRS_NAKL\BNZ%LPU%*.*YES
del /Q v:\Mrs\MRS_Dogovor\DGD%LPU%*.*YES
del /Q v:\Mrs\MRS_SYNC_ORACLE\%LPU%*.*YES
...
echo ╚эЇюЁьрЎш  ю яхЁхшьхэютрээ√ї Їрщырї эр FTP-ёхЁтхЁх: > %REN_LOGFILE%
echo. >> %REN_LOGFILE%
REM (код стр 1251 для команды DIR)
chcp 1251

REM Переименовываем на диске виртуального FTP-сервера
rename v:\Mrs\M2O00101$ORA%LPU%*.mrs   M2O00101$ORA%LPU%*.YES
rename v:\Mrs\M2O00101$ORA%LPU%*.zip   M2O00101$ORA%LPU%*.ZIPYES
rename v:\Mrs\M2O00101$ORA%LPU%*.rar   M2O00101$ORA%LPU%*.RARYES
dir    v:\Mrs\M2O00101$ORA%LPU%*.*YES | grep -i YES >> %REN_LOGFILE%
rename v:\Mrs\MRS_NAKL\BNZ%LPU%*.mrs   BNZ%LPU%*.YES
rename v:\Mrs\MRS_NAKL\BNZ%LPU%*.zip   BNZ%LPU%*.ZIPYES
rename v:\Mrs\MRS_NAKL\BNZ%LPU%*.rar   BNZ%LPU%*.RARYES
dir    v:\Mrs\MRS_NAKL\BNZ%LPU%*.*YES | grep -i YES >> %REN_LOGFILE%
rename v:\Mrs\MRS_Dogovor\DGD%LPU%*.mrs DGD%LPU%*.YES
rename v:\Mrs\MRS_Dogovor\DGD%LPU%*.zip DGD%LPU%*.ZIPYES
rename v:\Mrs\MRS_Dogovor\DGD%LPU%*.rar DGD%LPU%*.RARYES
dir    v:\Mrs\MRS_Dogovor\DGD%LPU%*.*YES | grep -i YES >> %REN_LOGFILE%
rename v:\Mrs\MRS_SYNC_ORACLE\%LPU%*.mrs %LPU%*.YES
rename v:\Mrs\MRS_SYNC_ORACLE\%LPU%*.zip %LPU%*.ZIPYES
rename v:\Mrs\MRS_SYNC_ORACLE\%LPU%*.rar %LPU%*.RARYES
dir    v:\Mrs\MRS_SYNC_ORACLE\%LPU%*.*YES | grep -i YES >> %REN_LOGFILE%
