...
REM FTP Сервер 
set FTP_SERVER=ftp://miks:2fwy5jpy@mics2.ltg.gazprom.ru
...
wget %FTP_SERVER%/Mrs/ -P./ -o../%LOGFILE% -N -c -nH -r --cut-dirs=1 -R%FILESYES% -A%FILES% -X/Mrs/MRS_AGGR,/Mrs/MRS_BACK,/Mrs/MRS_SF,/Mrs/ORACLE,/Mrs/XI,/Mrs/GKI,/Mrs/OD,/Mrs/ASBU,/Mrs/MRS_FOND 
...
GREP -i rar  	    SAVE%LOGFILE%
goto RAR%errorlevel%
:RAR2
:RAR1

GREP -i zip	    SAVE%LOGFILE%
goto ZIP%errorlevel%
:ZIP2
:ZIP1
