...
(SourceName <> 'Microsoft-Windows-DistributedCOM' And EventCode <> '10005' or EventCode <> '10016') And
(SourceName <> 'Windows Server Update Services' And EventCode <> '10032') And
(SourceName <> 'MSOIDSVC.EXE' And EventCode <> '0')